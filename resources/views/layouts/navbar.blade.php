            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    <a href="../../pages/authentication/signin/illustration.html" class="nav-link text-white font-weight-bold px-0" target="_blank">
                        ...
                        <div class="my-auto">
                            <img src="{{asset('assets/img/team-1.jpg')}}" class="avatar avatar-sm me-3" alt="user image">
                        </div>
                    </a>
                </li>
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    <a href="javascript:;" hidden class="nav-link text-white p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
