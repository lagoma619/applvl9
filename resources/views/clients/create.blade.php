                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="time" name="horario_final" id="horario_final" value="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-group">
                                <div class="form-control" id="notes" type="text">
                                    <textarea class="form-control-plaintext" id="notas" type="text" placeholder="ESCRIBA AQUÍ LAS NOTAS RELACIONADAS AL CLIENTE"></textarea>
                                </div>
                            </div>
                        </div>
